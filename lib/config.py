...
CONFIG_DEFAULT = {
	...
	"websites": {
		"cpu": {
			"value": ["https://netamitv.wispbyte.org/"],
			"desc": "List of websites to monitor for CPU section"
		},
		"memory": {
			"value": ["https://netamigames.wispbyte.org/"],
			"desc": "List of websites to monitor for Memory section"
		},
		"storage": {
			"value": ["https://mod.wispbyte.org/"],
			"desc": "List of websites to monitor for Storage section"
		},
		"network": {
			"value": ["https://vincent.wispbyte.org/"],
			"desc": "List of websites to monitor for Network section"
		},
		"host": {
			"value": [],
			"desc": "List of websites to monitor for Host section"
		}
	}
}
