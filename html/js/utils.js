...
function set(id, value) {
	console.log("set() called with id:", id, "value:", value)
	let element = get(id)
	if (element) {
		console.log("Element found, current innerText:", element.innerText)
		console.log("Setting innerText to:", value)
		element.innerText = value
		console.log("After setting, innerText is now:", element.innerText)
	} else {
